...
const AppDashboard = () => {
    ...
    const getRequests = () => {
      ...
      const approver = (requestId) => {
        axios
      .post("http://localhost:3001/req/approve", {requestId:requestId})
      .then(function (response) {
        alert("Approved by Approver");
  ...
  return (
    <div>
        ...
        <center><h1 className="text-3xl font-bold mt-6">Approver Dashboard</h1></center>
